...
class DetailBengkelMotor extends StatefulWidget {
  final int id;

  DetailBengkelMotor({required this.id});

  @override
  _DetailBengkelMotorState createState() => _DetailBengkelMotorState();
}

class _DetailBengkelMotorState extends State<DetailBengkelMotor> {
  late Future<Motor> _futureBengkelMotor;

  @override
  void initState() {
    super.initState();
    _futureBengkelMotor = fetchMotorDetail(widget.id);
  }
  ...
  Widget _buildDetail(Motor mobil) {
