...
import 'package:flutter_tm/mogok/towing/detail_towing.dart';
                ...
                child: Center(
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Towing & Derek terdekat dari lokasimu',
                      ...
                      SizedBox(height: 20),
                      FutureBuilder<List<TowingService>>(
                        future: fetchTowingData(),
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            return Column(
                              children: snapshot.data!.map((towing) {
                                return Column(
                                  children: [
                                    GestureDetector(
                                      onTap: () {
